...
<head>
    ...
    <title>Thêm Máy Tính Bảng</title>
    <style type="text/css">
        table,tr,td,th{
...
<body>
    <div class="Luoi50-50">
        ...
        <div class="Giua">
            <h3 class="titleTable">
                    <b>---Thêm dữ liệu máy tính bảng---</b>
            </h3>
             <form method="POST">
                <table>
                    <tbody>
            ...
            <?php
                if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['btnGhi'])){
                        ...
                        if (!$conn){
                            ...
                            $query1 = "SELECT * FROM tbl_maytinhbang  ";
                            ...
                            $Linksp = "sanpham.php?cha=-4&con=".$Id;
                            
                            $query2 = "INSERT INTO  tbl_maytinhbang VALUES('".$Id."','".$Loaisanpham."','".$Tensp."','".$Giacu."','".$Giamoi."','".$Linksp."','".$Linkanh."','".$Manhinh."','".$Camsau."','".$Camtruoc."','".$CPU."','".$ROM."','".$Tragop."','".$Daban."') ";
