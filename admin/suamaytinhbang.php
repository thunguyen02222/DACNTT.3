...
<body>
    <?php
            ...
            if (!$conn){
                ...
                $query = "SELECT * FROM tbl_maytinhbang WHERE id='".$Id."'";
    ...
    <div class="Luoi50-50">
        ...
        <div class="Giua">
                        ...
                        <tr>
                            ...
                            <td class="menuContent">
                                <select name="txtloaisp" class="menuInput">
                                    <option value="1" <?php echo $Loaisanpham==1 ? "selected" : ""; ?>>Ipad</option>
                                    <option value="2" <?php echo $Loaisanpham==2 ? "selected" : ""; ?>>Samsung</option>
                                    <option value="3" <?php echo $Loaisanpham==3 ? "selected" : ""; ?>>Lenovo</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
            ...
            <br>
        <div align="right"> <button> <a href="CSDLmaytinhbang.php" style="text-decoration: none;color: black;">Quay lại</a></button></button></div>
            <?php
                if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['btnGhi'])){
                    ...
                    if (!$conn){
                        ...
                        $query = "UPDATE tbl_maytinhbang SET id='".$Id."',loaimay='".$Loaisanpham."',tenmay='".$Tensp."',giacu='".$Giacu."',giamoi='".$Giamoi."',linksp='".$Linksp."',linkanh='".$Linkanh."',manhinh='".$Manhinh."',camerasau='".$Camsau."',cameraselfie='".$Camtruoc."',cpu='".$CPU."',bonhotrong='".$ROM."',tragop='".$Tragop."',daban='".$Daban."' WHERE id = '".$Id."' ";
                        $result = mysqli_query($conn,$query);
                        if ($result > 0){
